...
export default async function CityPropertiesPage({ params, searchParams = {} }: Props) {
  ...
  console.log("[v0] City page accessed with city:", cityName)
      ...
      <div className="bg-gray-50">
        <div className="container mx-auto px-4 py-4 bg-gray-50">
          <div className="mb-4 bg-gray-50">
            <h1 className="text-3xl font-bold text-[#2e057f] mb-5">Properties in {cityName}</h1>
            <p className="text-muted-foreground mb-5">Find the perfect accommodation in {cityName}</p>
          </div>
          ...
          <div className="text-center py-16">
            <div className="max-w-md mx-auto">
              ...
              <p className="text-gray-600 mb-8">
                We don't have any properties listed in {cityName} yet. Check back soon or explore other areas.
              </p>
              <a
                href="/properties"
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-[55px]">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-[#2e057f] mb-5">Properties in {cityName}</h1>
          <p className="text-muted-foreground mt-5">Find the perfect accommodation in {cityName}</p>
