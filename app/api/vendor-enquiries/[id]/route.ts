...
// GET - Fetch single vendor enquiry
export async function GET(
  ...
  try {
    ...
    const enquiry = await VendorEnquiry.findById(params.id);
...
// PUT - Update vendor enquiry (for responses, status changes, etc.)
export async function PUT(
  ...
  try {
    ...
    const enquiry = await VendorEnquiry.findByIdAndUpdate(
      params.id,
...
export async function DELETE(
  ...
  try {
    ...
    const enquiry = await VendorEnquiry.findByIdAndDelete(params.id);
