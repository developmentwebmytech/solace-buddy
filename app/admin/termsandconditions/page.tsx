...
export default function TermsAndConditionsList() {
  ...
  const fetchPolicies = () => {
    fetch("/api/admin/termsandconditions")
      .then((res) => res.json())
      .then(setPolicies)
  }
  ...
  const handleDelete = async (id: string) => {
    if (confirm("Are you sure you want to delete this terms and conditions entry?")) {
      await fetch(`/api/admin/termsandconditions/${id}`, {
        method: "DELETE",
      })
  ...
  return (
    <Card>
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <Link href="/admin/termsandconditions/new">
          <Button>
              ...
              <TableRow key={p._id}>
                ...
                <TableCell className="text-right">
                  <div className="flex justify-end gap-2">
                    <Link href={`/admin/termsandconditions/${p._id}`}>
