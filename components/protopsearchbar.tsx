...
export default function HomeTopSearchBar() {
  ...
  return (
    <section aria-label="Homepage Search" className="w-full bg-[#3a3c6e]">
      <div className="w-full text-white border px-4 py-4">
        <div className="grid grid-cols-1 md:grid-cols-[minmax(0,1fr)_minmax(0,1fr)_minmax(0,1fr)_minmax(0,2fr)_auto_auto] gap-3 items-end">
          {/* Gender */}
          <div>
            <div className="text-[11px] tracking-wide text-white mb-1">GENDER</div>
          ...
          {/* City */}
          <div>
            <div className="text-[11px] tracking-wide text-white  mb-1">City</div>
          ...
          {/* Area */}
          <div>
            <div className="text-[11px] tracking-wide text-white mb-1">AREA</div>
          ...
          {/* Search input */}
          <div>
            <div className="text-[11px] tracking-wide text-white mb-1">SEARCH</div>
