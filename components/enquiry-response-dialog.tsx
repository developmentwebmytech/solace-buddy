...
interface EnquiryResponseDialogProps {
  isOpen: boolean
  onClose: () => void
  onSuccess: () => void
  enquiry: any
...
export function EnquiryResponseDialog({ isOpen, onClose, onSuccess, enquiry }: EnquiryResponseDialogProps) {
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Send a response to {enquiry?.vendorName}'s enquiry about "{enquiry?.subject}"
          </DialogDescription>
        </DialogHeader>
